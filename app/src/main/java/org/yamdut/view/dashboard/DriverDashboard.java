...
public class DriverDashboard extends BaseDashboard {
    ...
    private ModernButton arrivedAtPickupButton;
    private ModernButton startTripButton;
    ...
    private JPanel createControlPanel() {
        ...
        // Arrived at pickup button (hidden initially)
        arrivedAtPickupButton = new ModernButton("📍 Arrived at Pickup", Theme.COLOR_ACCENT);
        arrivedAtPickupButton.setVisible(false);

        // Start trip button (hidden initially)
        startTripButton = new ModernButton("🚗 Start Trip", Theme.COLOR_PRIMARY);
        ...
        panel.add(arrivedAtPickupButton, gbc);
        panel.add(startTripButton, gbc);
    ...
    public void showActiveRide(String pickup, String destination, String passengerName) {
        ...
        // Customize for driver view
        activeRideCard.setInfoLabel("Passenger");
        activeRideCard.setDriverName(passengerName);
        ...
        // Hide accept button, show arrived at pickup button
        acceptRideButton.setVisible(false);
        arrivedAtPickupButton.setVisible(true);
        startTripButton.setVisible(false);
        completeRideButton.setVisible(false);
    }
    ...
    public void hideActiveRide() {
        ...
        // Show accept button, hide all others
    ...
    public void setDriverArrivedAtPickup() {
        arrivedAtPickupButton.setVisible(false);
    ...
    public ModernButton getArrivedAtPickupButton() {
        return arrivedAtPickupButton;
    }

    public ModernButton getStartTripButton() {
