...
public class Theme {
    ...
    public static Font getTitleFont() {
        return new Font("Nirmala UI", Font.BOLD, 28);
    }

    public static Font getSubtitleFont() {
        return new Font("Nirmala UI", Font.PLAIN, 14);
    }

    public static Font getHeadingFont() {
        return new Font("Nirmala UI", Font.BOLD, 18);
    }
    ...
    public static Font getButtonFont() {
        return new Font("Nirmala UI", Font.BOLD, 16);
    }

    public static Font getCaptionFont() {
        return new Font("Nirmala UI", Font.PLAIN, 12);
    }
